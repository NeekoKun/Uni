...
> 	Per il [[Criterio del Confonto per Serie a Termini non-negativi]], Poichè $\sum_{n=1}^{\infty}q_{n}$ diverge, diverge anche $\sum_{n=1}^{\infty}a_{n}$ (Serie Geometrica di ragione $q = \frac{l + 1}{2} > 1$)
